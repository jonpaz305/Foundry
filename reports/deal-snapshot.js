...
(function () {
  ...
  function _economics(mode, R, inputs, h) {
    ...
    if (mode === 'brrrr') {
      ...
      rows = [
        ['Purchase Price',       _withPd(h.fmtMoney(inputs.purchase_price), inputs.purchase_price)],
        ['Capex Budget',    _withPd(h.fmtMoney(inputs.capex_budget), inputs.capex_budget)],
        ['Total Project Cost',   _withPd(h.fmtMoney(R.total_project_cost), R.total_project_cost)],
        ['Initial Loan',         _withPd(h.fmtMoney(R.initial_loan_amt), R.initial_loan_amt)],
        ['Refi Loan',            _withPd(h.fmtMoney(R.refi_loan_amount), R.refi_loan_amount)],
      ...
      rows = [
        ...
        ['Total Project Cost',   _withPd(h.fmtMoney(R.total_project_cost), R.total_project_cost)],
        ['Initial Loan',         _withPd(h.fmtMoney(R.initial_loan_amt), R.initial_loan_amt)],
        ['ARV',                  _withPd(h.fmtMoney(R.arv), R.arv)],
        ['Sale Cost',            h.fmtMoney(R.sale_cost)],
        ['Net Investor Proceeds',_withPd(h.fmtMoney(R.net_investor_proceeds), R.net_investor_proceeds)],
        ['Investor Equity In',   _withPd(h.fmtMoney(R.investor_equity), R.investor_equity)],
